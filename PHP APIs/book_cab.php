					...
					function sendMessage(){
						...
						$content = array(
							"en" => 'You have got a new ride booking.'
						      ...
						      'data' => array("customerName" => $GLOBALS['customer_name'], "customerPhone"=>$GLOBALS['customer_phone'], "src_lat" => $GLOBALS['src_lat'], "src_lng" => $GLOBALS['src_lng'], "dest_lat"=>$GLOBALS['dest_lat'], "dest_lng" => $GLOBALS['dest_lng'], "fare" => $GLOBALS['fare'], "otp" => $GLOBALS['otp'], "ride_id" => $GLOBALS['ride_id'], "cab_id" => $GLOBALS['cab_id']),
